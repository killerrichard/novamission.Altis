...
IL_Crew_Only = false; 		Only allow PilotDriverCo-PilotGunnerCommander (does not include left & right gunners for choppers) to change the light
...
IL_text_ON = t color='#FF0000'Innenlicht ANt;
IL_text_OFF = t color='#FF0000'Innenlicht AUSt;
IL_Green_Text = t color='#00FF00'Zu Gruen wechselnt;
IL_Red_Text = t color='#FF0000'Zu Rot wechselnt;
IL_action = -1;
IL_lastchange = 0;
 Funktion
IL_fnc_inList = {
